...
import kotlinx.android.synthetic.main.item_recycler_view_public_message.view.*

/*************************************************************************************************
 * Displays a message in a public chat space
 ************************************************************************************************/
    ...
    : RecyclerView.ViewHolder(itemView)
{
    ...
    private val authorPhotoImageView by lazy { itemView.item_recycler_view_public_message_image_author }
    private val authorNameAndDateText by lazy { itemView.item_recycler_view_public_message_text_author_name_and_date }
    private val editButton by lazy { itemView.item_recycler_view_public_message_button_edit }
    private val deleteButton by lazy { itemView.item_recycler_view_public_message_button_delete }
    private val messageText by lazy { itemView.item_recycler_view_public_message_text_message }
